...
const bannerList = computed(() => {
  return goodInfo.value?.mainPictures || []
})
      ...
      <view class="preview">
        <swiper circular @change="onChange">
          <swiper-item v-for="(img, index) in bannerList" :key="index">
            <image @tap="onTapImage(img)" mode="aspectFill" :src="img" />
          </swiper-item>
        </swiper>
    ...
    <view class="detail panel">
      ...
      <view class="content">
        <view class="properties">
          <!-- 属性详情 -->
          <view class="item" v-for="property in goodInfo?.details.properties" :key="property.name">
        ...
        <!-- 图片详情 -->
        <image
          v-for="picture in goodInfo?.details.pictures"
          :key="picture"
          mode="widthFix"
          :src="picture"
        ></image>
